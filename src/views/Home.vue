    ...
    <aside :class="collapsed?'menu-collapsed':'menu-expanded'">
      ...
      <ul class="el-menu el-menu-vertical-demo collapsed" v-show="collapsed" ref="menuCollapsed">
        <li v-for="(item,index) in $router.options.routes" v-if="!item.hidden" class="el-submenu item">
          ...
          <template v-else>
        <li class="el-submenu">
          <div class="el-submenu__title el-menu-item" style="padding-left: 20px;height: 56px;line-height: 56px;padding: 0 20px;" :class="$route.path==item.children[0].path?'is-active':''" @click="$router.push(item.children[0].path)"><i
...
.container {
  ...
  a.home-tree {
    ...
    color: #fff;
    font-weight: bold;
    background: url(../assets/images/home-up.png) no-repeat;
  ...
  .header {
    height: 60px;
    line-height: 60px;
		// background: $color-primary; //蓝色
    background: #c60025; //蓝色
    color: #fff;
